...
print("Default Values of distance, time and elevation resp : \(firstRun.distance), \(firstRun.time)  and \(firstRun.elevation) ");
...
print("Values of distance, time and elevation resp : \(firstRun.distance), \(firstRun.time)  and \(firstRun.elevation) ");
/*:
