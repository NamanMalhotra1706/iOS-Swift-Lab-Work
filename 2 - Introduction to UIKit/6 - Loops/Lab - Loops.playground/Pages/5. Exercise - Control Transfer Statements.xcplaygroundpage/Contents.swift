...
for (index,eachAlphabet) in alphabet.enumerated()
{
    if(index.isMultiple(of: 2)){
        print("\(index)-->\(eachAlphabet)");
    }
}
...
var States: [String:String] = ["Punjab": "Abohar", "Haryana": "Ambala", "Delhi": "Modi"]

for (st,stC) in States{
    if(st=="Punjab"){
