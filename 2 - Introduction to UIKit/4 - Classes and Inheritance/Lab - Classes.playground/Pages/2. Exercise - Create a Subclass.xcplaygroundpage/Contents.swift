...
//print(falcon.weapon);
print("No it doesn't work, it will give scope error beacuse in Falcon class no weapon property exist, this weapon property exits in fighter class and fighter class is Subclass of falcon and falcon is base class for fighter")
...
destroyer.fire();
print("fire call \(destroyer.remainingFirePower)");
destroyer.fire();
print("fire call \(destroyer.remainingFirePower)");
destroyer.fire();
print("fire call \(destroyer.remainingFirePower)");
