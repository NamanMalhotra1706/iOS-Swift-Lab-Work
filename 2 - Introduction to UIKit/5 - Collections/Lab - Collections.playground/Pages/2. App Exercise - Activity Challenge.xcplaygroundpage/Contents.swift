 ...
 */
var walking : [String] = ["Walk 3 miles a day", "Chalte Chalo"];
var running : [String] = ["Run 5 times a week", "Bhagoooooo"];
print(walking);
print(running);
...
var usersCommittedChallenegs :[String] = ["Chalna hai Chlna hai"];
challenges.append(usersCommittedChallenegs);
print(challenges);
