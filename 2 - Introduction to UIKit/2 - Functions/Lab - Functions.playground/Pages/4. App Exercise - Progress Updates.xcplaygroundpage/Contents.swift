...
var current :Double = 120;
let toalDis :Double = 120;
var time : Double = 20;
let goalTime : Double = 20;

func pacing (currentDistance: Double, totalDistance:Double, currentTime:Double, goalTime:Double){
    if(currentTime==totalDistance && currentTime<=goalTime){
        print("Keep it up!")
    }
    else{
...
pacing(currentDistance: current, totalDistance: toalDis, currentTime: time, goalTime: goalTime);
