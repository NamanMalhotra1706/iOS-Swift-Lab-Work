...
print("User age value is \(String(describing: userAge))  its nil beacuse of optional binding we made the type Int to optional(Int) so the value nil is stored to userAge");
