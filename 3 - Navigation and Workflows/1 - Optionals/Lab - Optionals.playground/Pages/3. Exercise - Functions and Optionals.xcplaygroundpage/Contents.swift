...
//}
//
//userAge(input: userInputAge);
//:  Go back and update your function to return the age as an integer. Will your function always return a value? Make sure your return type accurately reflects this. Call the function and print the return value.
func userAge(input Age:String)->Int?{
...
print(userAge(input: userInputAge));
...
func purchased(item it:String) -> Double?{
...
if let purchasedItem = purchased(item: "Chips"){
    print("The value of Chips are: \(purchasedItem) ")
}
/*:
